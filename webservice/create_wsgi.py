...
WSGI_FILENAME = 'nmr_prediction_app.wsgi'
site_fname = "nmr_prediction-site.conf"
...
if __name__ == '__main__':
    ...
    # print "I am going to configure everything running as user '{}' and group '{}'".format(current_user, current_group)
    ...
    site_file_content = site_template.substitute(
        ...
        appname="nmr_prediction_app",
        user=current_user,
        group=current_group,
        numthreads=4,
        urlpath='/nmr_prediction',
        wsgipath=wsgi_file,
